        ...
        <div class="modal-content form-elegant">
            ...
            <div class="modal-body mx-4">
                ...
                <div class="md-form mb-5">
                    <input placeholder="Your email" type="email" id="Form-email1" class="form-control validate">
                    <label data-error="wrong" data-success="right" for="Form-email1"></label>
                </div>

                <div class="md-form pb-3">
                    <input placeholder="Your Password" type="password" id="Form-pass1" class="form-control validate">
                ...
                <div class="text-center mb-3">
                    <button type="button" class="btn blue-gradient btn-block btn-rounded z-depth-1a" style="font-weight: 500; border-radius: 20px;">Sign in</button>
                </div>
