...
<div class="modal fade" id="signupForBookingForm" data-keyboard="false" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body mx-4">
                ...
                <form action="" method="">
                    ...
                    <div class="text-center mb-3">
                        <button type="button" data-dismiss="modal" data-toggle="modal"  data-target="#petInfoForm" class="btn blue-gradient btn-block btn-rounded z-depth-1a" style="font-weight: 500; border-radius: 20px;">Next</button>
                    </div>
