...
<html lang="en">
    ...
    <script>
        ...
        function next() {
            ...
            console.log("Property :" + aptNo + street + state + country + zipCode + contactName + managerEmail + bookingEmail + website + phone + description + directions);
...
//            console.log(JSON.stringify(Hotel));
            $('#result').val(JSON.stringify(Hotel));
            $("#register").submit();
        }
    </script>
    <style>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            ...
                                            <button onClick="next();">Here</button>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div class="x_content">
                                                        ...
                                                        <div class="x_content">
                                                            ...
                                                            <form class="form-horizontal form-label-left">
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input id="aptNo" class="form-control col-md-7 col-xs-12" data-validate-length-range="2" data-validate-words="1" name="aptNo" placeholder="3A" required="required" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input id="street" class="form-control col-md-7 col-xs-12" data-validate-length-range="8" data-validate-words="2" name="street" placeholder="Zanpad" required="required" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="item form-group">
                                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="state">City <span class="required">*</span>
                                                                    </label>
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input id="state" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-words="1" name="state" placeholder="Amsterdam" required="required" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input id="country" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" data-validate-words="1" name="country" placeholder="Netherlands" required="required" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input id="zipcode" class="form-control col-md-7 col-xs-12" data-validate-length-range="2" data-validate-words="1" name="zipcode" placeholder="1054" required="required" type="text">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <form class="form-horizontal form-label-left">
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input  id="contactName" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="contactName" placeholder="both name(s) e.g Jon Doe" required="required" type="text">
                                                                    </div>
                                                                </div>
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input id="managerEmail"  class="form-control col-md-7 col-xs-12">
                                                                    </div>
                                                                </div>
                                                                <div class="item form-group">
                                                                    ...
                                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        <input type="text" id="bookingEmail" name="bookingEmail" required="required" class="form-control col-md-7 col-xs-12">
                                                                    </div>
                                                                </div>
                                                                <div class="item form-group">
                                                    ...
                                                    <div class="x_panel">
                                                        ...
                                                        <div class="x_content">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-9 col-sm-9 col-xs-12">
                                                                    <textarea  id="directions" class="form-control" rows="3" placeholder="Tell your customers how to get to your property from the bus station, train station, airport, city centre etc. Remember they may never have been to your city before."></textarea>
                                                                </div>
                                                            </div>
                                                            <br>
                                                        </div>
