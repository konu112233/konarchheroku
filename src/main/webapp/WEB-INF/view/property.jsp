                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-content form-elegant">
                                                ...
                                                <div class="modal-body mx-4">
                                                    ...
                                                    <br>
                                                    <div class="md-form">
                                                        <input id="newPetName" placeholder="Pet Name" type="text" name="name" class="form-control validate">
                                                    ...
                                                    <div class="md-form">
                                                        <input id="newPetAge" placeholder="Age" type="text" name="age" class="form-control validate">
                                                        <label data-error="wrong" data-success="right" ></label>
                                                    </div>
                                                    <div class="md-form">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-8 col-sm-12 col-xs-12" style="margin-top:-12px">
                                                                ...
                                                                <div style="margin-left:25px" class="custom-control custom-radio custom-control-inline">
                                                                    ...
                                                                    <label class="custom-control-label" onclick="whichGender('Male')" for="defaultInline1">Male</label>
                                                                </div>
                                                    ...
                                                    <div class="md-form mb-5">
                                                        ...
                                                        <!-- Material inline 2 -->
                                                        <div class="form-check form-check-inline">
                                                            <input onclick="whichSize('10-20 kg')" type="radio" class="form-check-input" id="materialInline2" name="inlineMaterialRadiosExample">
