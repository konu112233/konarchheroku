                                        ...
                                        <div class="x_content">
                                            ...
                                            <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                                                <form action="editProfile" id="user_info">
                                                    ...
                                                    <h3 id = "name">Steave Brunn</h3>
                                                    <ul class="list-unstyled user_data">
                                                        <li id="address"><i class="fa fa-map-marker user-profile-icon"></i> Oosterdokskade 143, 1011 DL Amsterdam
                                                        </li>
                                                        <li id="mail">
                                                            <i class="fa fa-briefcase fa-envelope" ></i> steave_brunn@gmail.com
                                                        </li>
                                                        <li class="m-top-xs">
                                                            <i class="fa fa-phone user-profile-icon"></i>
                                                            <a href="" target="_blank" id="telephone">+41 545 752 22</a>
                                                        </li>
                                                        <li class="m-top-xs">
                                                            <i class="fa fa-birthday-cake user-profile-icon"></i>
                                                            <a href="" target="_blank" id="bod">42 y.o.</a>
                                                        </li>
                                                        <li class="m-top-xs">
                                                            <i class="fa fa-mars fa-ll user-profile-icon"></i>
                                                            <a href="" target="_blank" id="gender">Male</a>
                                                        </li>
                                                    </ul>
