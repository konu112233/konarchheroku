                                    ...
                                    <form action="previewHotel" class="form-horizontal form-label-left" id="hotel_info">
                                        <div class="x_title">
                                            ...
                                            <div  style="text-align: right;">
                                                ...
                                                <button type="submit" class="buttonNext btn btn-success btn-sm">Preview</button><small> your hotel </small>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input  type="text" id="hotel_name" value="" class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Street <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="street"  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label  col-md-3 col-sm-3 col-xs-12" for="first-name">Zip code <span></span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="zipcode"  class="form-control col-md-7 col-xs-12">
                                            </div>
                                        </div>
                                        <div class="form-group" >
