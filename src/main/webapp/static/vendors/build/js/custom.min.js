    ...
    if ("undefined" != typeof $.fn.cropper) {
        ...
        $('[data-toggle="tooltip"]').tooltip(), a.on({
            ...
            if (!c.prop("disabled") && !c.hasClass("disabled") && a.data("cropper") && d.method) {
                if (d = $.extend({}, d), "undefined" != typeof d.target && (e = $(d.target), "undefined" == typeof d.option))
                    try {
        ...
        var e, f, a = new Date,
            ...
            select: function (a, b, c) {
                $("#fc_create").click(), e = a, ended = b, $(".antosubmit").on("click", function () {
                    ...
                    var type = $("input[name=options]").val();
                    return b && (ended = b), f = $("#event_type").val(), a && g.fullCalendar("renderEvent", {
                        title: a,
                        start: e,
                        end: b,
                        allDay: c
                    }, !0), console.log(a + " " + startDate + " " + endDate + " " + type), $("#title").val(""), g.fullCalendar("unselect"), $(".antoclose").click(), !1
                })
            },
