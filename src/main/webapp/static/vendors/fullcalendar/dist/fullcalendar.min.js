...
!function (t) {
    ...
    function L(e) {
        ...
        for ("string" == typeof e ? s = e.split(/\s*,\s*/) : "function" == typeof e ? s = [e] : t.isArray(e) && (s = e), n = 0; n < s.length; n++)
            i = s[n], "string" == typeof i ? r.push("-" == i.charAt(0) ? {
                field: i.substring(1),
                order: -1
            } : {
                field: i,
    ...
    function F(t, e) {
        var n,
                ...
                u = e.end;
        if (l > a && o < u)
            return o >= a ? (n = o.clone(), r = !0) : (n = a.clone(), r = !1), l <= u ? (i = l.clone(), s = !0) : (i = u.clone(), s = !1), {
                start: n,
                end: i,
                isStart: r,
                isEnd: s
    ...
    function pt(t, e, n, i, r) {
        ...
        for (o = 0; o < n.length && (s = vt(t, e, u, c, n[o]), s !== !1); o++)
            d += s;
        for (l = n.length - 1; l > o && (s = vt(t, e, u, c, n[l]), s !== !1); l--)
            h = s + h;
        for (a = o; a <= l; a++)
            f += ft(t, n[a]), g += ft(e, n[a]);
    ...
    function _t(n, i) {
        ...
        function h(t) {
            if (a())
                return t && g(), nt++, Q.updateSize(!0), nt--, !0
        }
        function f() {
            a() && g()
        }
        ...
        function V(t) {
            ...
            if (1 === n) {
                ...
                if ("defaultDate" === e)
                    return;
                if ("businessHours" === e)
                    return void (Q && (Q.unrenderBusinessHours(), Q.renderBusinessHours()));
                if ("timezone" === e)
    ...
    function Ut() {
        ...
        function f(e, n) {
            ...
            for (i = 0; i < s.length; i++) {
                if (r = s[i].call(U, e, q.clone(), Z.clone(), U.options.timezone, n), r === !0)
                    return;
                if ("object" == typeof r)
                    return void f(r, n)
            }
            var o = e.events;
            if (o)
                t.isFunction(o) ? (U.pushLoading(), o.call(U, q.clone(), Z.clone(), U.options.timezone, function (t) {
                    n(t), U.popLoading()
                })) : t.isArray(o) ? n(o) : n();
            else {
                var l = e.url;
    ...
    re.push("_fullCalendar"), re.push("_ambigTime"), re.push("_ambigZone"), qt.moment = function () {
        ...
        if (!this._fullCalendar)
            return ie.time.apply(this, arguments);
        if (null == t)
            return e.duration({
                hours: this.hours(),
    ...
    qt.queryMostGranularFormatUnit = function (t) {
        ...
        for (e = 0; e < s.length; e++)
            n = s[e], n.token && (i = ae[n.token.charAt(0)], i && (!r || i.value > r.value) && (r = i));
        ...
        if (e && "function" == typeof e.resolve)
            return e.promise();
        ...
        if (bt.immediate)
            for (s = !0, n = [], i = 0; i < e.length; i++)
                if (r = e[i], r && "function" == typeof r.state && "resolved" === r.state() && "_value" in r)
                    n.push(r._value);
                else {
    ...
    var ye = qt.DayTableMixin = {
        ...
        sliceRangeByRow: function (t) {
            ...
            for (e = 0; e < this.rowCnt; e++)
                n = e * o, i = n + o - 1, r = Math.max(a, n), s = Math.min(u, i), r = Math.ceil(r), s = Math.floor(s), r <= s && c.push({
                    row: e,
        ...
        sliceRangeByDay: function (t) {
            ...
            for (e = 0; e < this.rowCnt; e++)
                for (n = e * l, i = n + l - 1, r = n; r <= i; r++)
                    s = Math.max(u, r), o = Math.min(c, r), s = Math.ceil(s), o = Math.floor(o), s <= o && d.push({
                        row: e,
        ...
        bookendCells: function (t) {
            ...
            Se = qt.DayGrid = me.extend(ye, {
                ...
                renderDrag: function (t, e) {
                    if (this.renderHighlight(this.eventToSpan(t)), e && e.component !== this)
    ...
    Se.mixin({
        ...
        computeRowLevelLimit: function (e) {
            ...
            for (i = 0; i < a.length; i++)
                if (r = a.eq(i).removeClass("fc-limited"), s = 0, r.find("> td > :first-child").each(n), r.position().top + s > l)
                    return i;
            return !1
        },
    ...
    var Ee = qt.View = St.extend(ue, ce, {
        ...
        initHiddenDays: function () {
            var e,
                    ...
                    i = [],
                    r = 0;
            for (this.opt("weekends") === !1 && n.push(0, 6), e = 0; e < 7; e++)
    ...
    var De = qt.Calendar = St.extend({
        ...
        buildViewSpec: function (t) {
            for (var i, r, s, o, l = this.overrides.views || {}, a = [], u = [], c = [], d = t; d; )
                i = Zt[d], r = l[d], d = null, "function" == typeof i && (i = {
                    class: i
    ...
    De.prototype.normalizeEvent = function (t) {}, De.prototype.spanContainsSpan = function (t, e) {
        ...
        for (o = this.getPeerEvents(t, i), l = 0; l < o.length; l++)
            if (a = o[l], this.eventIntersectsRange(a, t)) {
                if (n === !1)
                    return !1;
                if ("function" == typeof n && !n(a, i))
                    return !1;
                if (i) {
                    if (u = J(a.overlap, (a.source || {}).overlap), u === !1)
                        return !1;
                    if ("function" == typeof u && !u(i, a))
                        return !1
                }
            }
        return !0
    ...
    De.prototype.getCurrentBusinessHourEvents = function (t) {
        ...
        for (r = 0; r < n.length; r++)
            s = n[r], i && !s.dow || (s = t.extend({}, ke, s), e && (s.start = null, s.end = null), l.push.apply(l, this.expandEvent(this.buildEventFromInput(s), o.start, o.end)));
        return l
    };
