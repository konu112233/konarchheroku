...
public class HotelDashboardDAOImpl implements HotelDashboardDAO {
    ...
    public boolean registerHotel(User user) {
        ...
        HttpResponse<JsonNode> response = Unirest.post("https://bookingpetswebservice.herokuapp.com/webapi/hotel/registerHotel")
    ...
    public Status checkStatus(String token) {
        ...
        HttpResponse<JsonNode> response = Unirest.post("https://bookingpetswebservice.herokuapp.com/webapi/hotel/status")
                .header("Content-type", "application/json")
