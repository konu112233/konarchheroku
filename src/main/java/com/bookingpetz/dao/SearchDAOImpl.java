...
public class SearchDAOImpl implements SearchDAO {
    ...
    public List<SearchResult> resultSearch(Search search) {
        HttpResponse<String> response = Unirest.post("http://localhost:8080/BookingPetsREST/webapi/calendar/searchResult")
    ...
    public SearchResult getProperty(String code) {
        ...
        HttpResponse<String> response = Unirest.post("http://localhost:8080/BookingPetsREST/webapi/hotel/getProperty")
