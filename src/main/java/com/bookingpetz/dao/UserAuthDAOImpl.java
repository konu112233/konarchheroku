...
public class UserAuthDAOImpl implements UserAuthDAO {
    ...
    public UserToken login(UserAuth userAuth) {
        HttpResponse<JsonNode> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/login")
    ...
    public boolean logout(String token) {
        HttpResponse<String> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/auth/logout")
                .header("Content-type", "application/json")
    ...
    public boolean signUp(User user) {
        HttpResponse<String> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/signUp")
                .header("Content-type", "application/json")
    ...
    public boolean checkUsername(String email) {
        ...
        HttpResponse<String> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/checkUsername")
                .header("Content-type", "application/json")
    ...
    public boolean confirmationMail(User user) {
        HttpResponse<String> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/confirmationMail")
                .header("Content-type", "application/json")
                .body(new Gson().toJson(user))
                .asString();
    ...
    public boolean verifyMail(String key) {
        ...
        HttpResponse<String> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/verifymail")
                .header("Content-type", "application/json")
                .body(jsono.toJSONString())
                .asString();
    ...
    public boolean resetPasswordSendMail(String email) {
        ...
        HttpResponse<String> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/resetPasswordSendMail")
                .header("Content-type", "application/json")
                .body(jsono.toJSONString())
                .asString();
    ...
    public boolean updatePassword(String code, String password) {
        HttpResponse<String> response = Unirest.post("https://bookingpets.herokuapp.com/webapi/gateway/updatePassword")
                .header("Content-type", "application/json")
